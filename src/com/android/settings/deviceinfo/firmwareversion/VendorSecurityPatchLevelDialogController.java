...
public class VendorSecurityPatchLevelDialogController {
    ...
    private static final String KEY_LEMON_VENDOR_SECURITY_PATCH =
            "ro.lemon.build.vendor_security_patch";
    ...
    private String getVendorSecurityPatchLevel() {
        ...
        if (patchLevel.isEmpty()) {
            patchLevel = SystemProperties.get(KEY_LEMON_VENDOR_SECURITY_PATCH);
        }
